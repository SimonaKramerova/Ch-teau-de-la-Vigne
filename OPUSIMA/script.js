...
// =======================
// Načítání dat do galerie (přes JS)
const expoziceData = [
  ...
  // můžeš přidat další data
];

function zobrazExpozice() {
  const container = document.getElementById('expozice').querySelector('.exhibition-grid');
...
document.querySelector('form').addEventListener('submit', function(e) {
    ...
    // zde můžeš přidat uložením do localStorage nebo jinou logiku
});